  ...
  return (
    <Card sx={{ maxWidth: 345 }}>
      <CardHeader
        ...
        title={
          <Typography className="movieTitle" variant="h5" component="p">
            {movie.title}{" "}
          </Typography>
        }
      />
      ...
      <CardContent>
        <Grid container>
          <Grid item xs={6}>
            <Typography className="releaseDate" variant="h6" component="p">
              <CalendarIcon fontSize="small" />
              {movie.release_date}
            </Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography className="rating" variant="h6" component="p">
